...
router.get('/seller-transaction-update', auth(USER_ROLES.SELLER), DashboardController.transactionUpdate)
...
router.get('/admin-seller-monthly-onboarding', auth(USER_ROLES.ADMIN, USER_ROLES.SUPER_ADMIN), DashboardController.sellerMonthlyOnboarding)
...
router.get('/admin-top-sellers', auth(USER_ROLES.ADMIN, USER_ROLES.SUPER_ADMIN), DashboardController.topSellersByMonth)
